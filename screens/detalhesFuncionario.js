...
export default class TelaDetalhesFuncionario extends Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      item: params,
      nome: params._postadoPor,
      nomeVaga: params.nomeVaga,
  ...
  editar() {
    this.props.navigation.navigate("AdicionarFuncionario", { item: this.state.item });
  }
  ...
  excluir() {
    ...
    FirebaseHelper.removerFuncionario({ id: this.state.id }, () => {
      this.setState({
        snackbarMensagem: "Os dados foram removidos com sucesso! Para que as alterações sejam percebidas, é necessário reiniciar o aplicativo!",
    ...
    return (
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.titulo}>Detalhes do empregado</Text>
        </View>

        <ScrollView>
          <Text style={styles.itemTitulo}>{this.state.nomeVaga}</Text>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start', alignSelf: 'stretch' }}>
            ...
            <Text style={{ textAlign: 'center', fontSize: 14, fontFamily: "Book", color: '#333' }}>{this.state.nome}</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start', alignSelf: 'stretch' }}>
            <Ionicons name="calendar-outline" color="#333" size={30} style={{ margin: 5, marginLeft: 10 }} />
            <Text style={{ textAlign: 'center', fontSize: 14, fontFamily: "Book", color: '#333' }}>{this.state.pub}</Text>
          </View>

          <View style={{ flexDirection: 'column', alignItems: 'flex-start', justifyContent: 'flex-start', alignSelf: 'stretch', marginLeft: 10 }}>
            <Text style={styles.itemSubtitulo}>Habilidades</Text>
            <Text style={{ textAlign: 'center', fontSize: 14, fontFamily: "Book", color: '#333' }}>{this.state.habilidades}</Text>
          </View>
          ...
          <View style={{ flexDirection: 'column', alignItems: 'flex-start', justifyContent: 'flex-start', alignSelf: 'stretch', marginLeft: 10, marginTop: 10 }}>
            <Text style={styles.itemSubtitulo}>Escolaridade</Text>
            <Text style={{ textAlign: 'center', fontSize: 14, fontFamily: "Book", color: '#333' }}>{this.state.escolaridade}</Text>
          </View>
          ...
          {this.state.editar &&
            <Button
              ...
              <Text style={styles.btn}>EDITAR DADOS</Text>
            </Button>
          }
          ...
          {this.state.editar &&
            <Button
              ...
              style={!this.state.botaoDisabled ? styles.botao : styles.botaoDesativado}
              disabled={this.state.botaoDisabled}>
              <Text style={styles.btn}>EXCLUIR DADOS</Text>
            </Button>
          }
        </ScrollView>
